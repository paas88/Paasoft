...
@Named("terceroController")
@SessionScoped
public class TerceroController implements Serializable {

    @EJB
    private com.paasoft.paasysfact.session.TerceroFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("TerceroCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("TerceroUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("TerceroDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Tercero getTercero(java.lang.Integer id) {
    ...
    @FacesConverter(forClass = Tercero.class)
    public static class TerceroControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getTercero(getKey(value));
        }
