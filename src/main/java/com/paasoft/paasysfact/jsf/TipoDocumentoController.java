...
import com.paasoft.paasysfact.entities.TipoDocumento;
import com.paasoft.paasysfact.jsf.util.JsfUtil;
import com.paasoft.paasysfact.jsf.util.JsfUtil.PersistAction;
import com.paasoft.paasysfact.session.TipoDocumentoFacade;
...
public class TipoDocumentoController implements Serializable {
    ...
    @EJB
    private com.paasoft.paasysfact.session.TipoDocumentoFacade ejbFacade;
