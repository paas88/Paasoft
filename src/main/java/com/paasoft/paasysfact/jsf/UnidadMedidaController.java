...
import com.paasoft.paasysfact.entities.UnidadMedida;
import com.paasoft.paasysfact.jsf.util.JsfUtil;
import com.paasoft.paasysfact.jsf.util.JsfUtil.PersistAction;
import com.paasoft.paasysfact.session.UnidadMedidaFacade;
...
public class UnidadMedidaController implements Serializable {
    ...
    @EJB
    private com.paasoft.paasysfact.session.UnidadMedidaFacade ejbFacade;
    ...
    public UnidadMedida getUnidadMedida(java.lang.Integer id) {
